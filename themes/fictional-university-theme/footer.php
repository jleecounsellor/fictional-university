      ...
      <div class="site-footer__inner container container--narrow">
        <div class="group">
          <div class="site-footer__col-one">
            ...
            <p><a class="site-footer__link" href="<?php echo esc_url(site_url('/')); ?>">555.555.5555</a></p>
          </div>
            ...
            <div class="site-footer__col-two">
              ...
              <nav class="nav-list">
                <ul>
                  ...
                  <li><a href="<?php echo get_post_type_archive_link('event'); ?>"><a href="<?php echo esc_url(site_url('/events')); ?>">Events</a></li>
